...
public class output1 {
	...
	public void outputs1() {
		try {
			output1 window = new output1(); //creates window in class output1
	...
	protected void createContents() {
		...
		lblLabel3.setText("1. Country Music is " + music.txtA.getText() + ". The concerts are always "
				+ music.txtB.getText() + " in " + music.txtC.getText() + ".");
		...
		lblLabel4.setText("2. My favorite genre is " + music.txtD.getText() + ". I mainly listen to it at " + 
				music.txtE.getText() + " while doing " + music.txtF.getText() + ".");
		//Makes the label print what is said and also gets the text from the Sports class
		...
		lblLabel5.setText("3. My favorite artist is " + music.txtG.getText() + ". They make "+ music.txtH.getText() 
				+ " music. My favorite song by them is " + music.txtI.getText() + ".");
		//Makes the label print what is said and also gets the text from the Sports class
		...
		btnYes.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(e.getSource()==btnYes) {
					...
					shell.dispose();
					madlib.main(null);
				}//states if button is pressed dispose music shell and current shell and open main from madlib class
			}
		});
